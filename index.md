...
Welcome to the CWD Toolkit—we’re so glad you’re here. The CWD Toolkit is a learning resource and template created to simplify the creation of professional static sites for anyone  interested in showcasing their projects or research digitally. This site was built to live up to our core value's of sustainability and accessibility while maintaining an easy-to-use and sleek design.
